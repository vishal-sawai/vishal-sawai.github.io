...
const Timeline = ({ company_name, jobTitle, summary, startDate, endDate, bulletPoints, key }) => {
    const startYear = new Date(startDate).getFullYear();
    const endYear = new Date(endDate).getFullYear();

    return (

        <div key={key} className="relative pl-8 sm:pl-32 py-3 group before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 sm:before:ml-[6.5rem] before:self-start before:-translate-x-1/2 before:translate-y-3">
